        ...
        <Container>
          <Row>
            <Col lg='8' md='6'>
              ...
              <form className='checkout__form mb-4' onSubmit={submitHandler}>
                ...
                <button className='addToCart__btn mb-5'>Payment</button>
              </form>
            </Col>
            <Col lg='4' md='6'>
              <div className='checkout__bill mb-4'>
                <h6 className='d-flex align-items-center justify-content-between mb-3'>Subtotal : <span>Rs. {cartTotalAmount}</span></h6>
                <h6 className='d-flex align-items-center justify-content-between mb-3'>Shipping : <span>Rs. {shippingCost}</span></h6>
                <div className='checkout__total'>
                  <h5 className='d-flex align-items-center justify-content-between'>Total : <span>Rs. {totalAmount}</span></h5>
                </div>
              </div>
            </Col>
          </Row>
